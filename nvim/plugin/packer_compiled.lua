...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    loaded = true,
    path = "/home/vscode/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["cmp-cmdline"] = {
    loaded = true,
    path = "/home/vscode/.local/share/nvim/site/pack/packer/start/cmp-cmdline",
  ...
  ["vim-vinegar"] = {
    loaded = true,
    path = "/home/vscode/.local/share/nvim/site/pack/packer/start/vim-vinegar",
